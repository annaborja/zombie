<div class="row-fluid">
    ...
    <div class="span10">
        <section id="top"><div class="hero-unit">
            ...
            <div class="row-fluid">
                <img class="span4" src="/assets/img/saturn.jpg"
...
<div class="row-fluid">
    <div class="span10">
        <section id="1"><div class="hero-unit">
            ...
            <div class="row-fluid">
                <img class="span12" src="/assets/img/supplies.jpg" alt="Canned food"
...
<div class="row-fluid">
    ...
    <div class="span10">
        <section id="2"><div class="hero-unit">
            ...
            <div class="row-fluid">
                <img class="span12" src="/assets/img/brain.jpg" alt="A human brain"
                    title="Original photo by John A Beal,
...
<div class="row-fluid">
    <div class="span10">
        <section id="3"><div class="hero-unit">
            ...
            <div class="row-fluid">
                <img class="span12" src="/assets/img/run.jpg" alt="Someone running"
...
<div class="row-fluid">
    <div class="span1">&nbsp;</div>
    <div class="span10">
        <section id="4"><div class="hero-unit footer">
            <h1 class="text-center">End</h1>
            <p>Well, that's it! Good luck!</p>
            <div class="row-fluid">
                <img class="span12" src="/assets/img/sunrise.jpg" alt="Sunrise"
                    title="Original photo by Simon Eugster
